...
export const light = {
  ...
  "base-200": baseLight.darken(0.3).hex(),
  "base-300": baseLight.darken(0.6).hex(),
...
export const dark = {
  ...
  error: errorDark.hex(),
  "error-content": white.hex(),
  "base-100": baseDark.hex(),
  "base-200": baseDark.brighten(0.4).hex(),
  "base-300": baseDark.brighten(0.8).hex(),
